...
public class QueryParamsWithEssayBuilder : IQueryParamsWithEssayBuilder
{
    ...
    public IQueryable<T>? BuildQueriesWords<T>(QueryParamsWithEssayFilters filters)
    {
    ...
    public IQueryable<T>? BuildQueriesDiscussions<T>(QueryParamsWithEssayFilters filters)
    {
    ...
    public IQueryable<T>? BuildQueriesQuestions<T>(QueryParamsWithEssayFilters filters)
    {
