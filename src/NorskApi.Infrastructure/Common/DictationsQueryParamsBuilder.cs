...
public class DictationsQueryParamsBuilder : IQueryParamsWithEssayBuilder
{
    private readonly NorskApiDbContext dbContext;

    public DictationsQueryParamsBuilder(NorskApiDbContext dbContext)
    {
        this.dbContext = dbContext;
    }

    public IQueryable<T>? BuildQueries<T>(QueryParamsWithEssayFilters filters)
    {
