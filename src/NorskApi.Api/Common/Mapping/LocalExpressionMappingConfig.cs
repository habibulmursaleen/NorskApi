...
public class LocalExpressionMappingConfig : IRegister
{
    public void Register(TypeAdapterConfig config)
    {
        ...
        config.NewConfig<CreateLocalExpressionRequest, CreateLocalExpressionCommand>()
        ...
        config
        .NewConfig<(Guid id, UpdateLocalExpressionRequest request), UpdateLocalExpressionCommand>()
        ...
        config.NewConfig<Guid, DeleteLocalExpressionCommand>()
            .Map(dest => dest.Id, src => src);

        // Map from LocalExpressionResult to LocalExpressionResponse
        config.NewConfig<LocalExpressionResult, LocalExpressionResponse>()
            .Map(dest => dest.Id, src => src.Id)
            .Map(dest => dest.Label, src => src.Label)
            .Map(dest => dest.Description, src => src.Description)
            .Map(dest => dest.MeaningInNorsk, src => src.MeaningInNorsk)
