...
public class CreateWordHandler : IRequestHandler<CreateWordCommand, ErrorOr<WordResult>>
{
    private readonly IWordRepository wordRepository;

    public CreateWordHandler(IWordRepository wordRepository)
    {
    ...
    )
    {
        Word word = Word.Create(
            EssayId.Create(command.EssayId ?? Guid.Empty),
            command.Title,
            command.Meaning,
        ...
        await this.wordRepository.Add(word, cancellationToken);
